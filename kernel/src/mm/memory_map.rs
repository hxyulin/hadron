...
pub struct MemoryMap {
    pub alloc: SharedLock<BumpAllocator>,
    pub entries: Vec<MemoryRegion, SharedLock<BumpAllocator>>,
...
pub struct MemoryRegion {
    ...
    pub(super) bitmap: Bitmap<SharedLock<BumpAllocator>>,
}
...
impl MemoryRegion {
    pub fn from_base_and_length(base: PhysAddr, length: usize, alloc: SharedLock<BumpAllocator>) -> Self {
