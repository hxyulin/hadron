...
pub const MEMORY_MAPPINGS: VirtAddr = VirtAddr::new(0xFFFF_FFFF_E000_0000);
pub const MEMORY_MAPPINGS_SIZE: u64 = 0xFFFF_FFFF_F000_0000 - MEMORY_MAPPINGS.as_u64();
pub const MMIO_SPACE: VirtAddr = VirtAddr::new(0xFFFF_FFFF_F000_0000);
